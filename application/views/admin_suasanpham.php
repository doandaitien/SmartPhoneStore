...
<head>
	...
	<!-- load file dinh kem -->
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>vendor/CSS/suasanpham.css">
	<script type="text/javascript" src="<?php echo base_url(); ?>vendor/JS/suasanpham.js"></script>
		...
		<div class="row">
	        ...
	        <div class="col-md-10" style="overflow-y: scroll;overflow-x: hidden;position: relative;">
	        	...
	        	<div class="themsanpham" style="position: absolute;top: 13%;z-index: 3;margin-left: 40px;">
					...
					<div class="text-center"><h2 class="td">Sửa sản phẩm</h2></div>
					<div class="container">
						<div class="row">
							...
							<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
								...
								<form action="<?php echo base_url(); ?>index.php/admin/DK_ChinhSuaSanPham/<?= $value['PID'] ?>" method="POST" role="form">
				        			<div class="form-group">
				        				<label for="">Tên sản phẩm</label>
				        				<input type="text" class="form-control" id="" name="tensp" placeholder="Enter name" value="<?= $value['NameProduct'] ?>" required>
				        			</div>
				        			<div class="form-group">
				        				<label for="">Hãng SX</label>
				        				<input type="text" class="form-control" id="" name="hangsx" placeholder="Enter Supplier" value="<?= $value['Supplier'] ?>" required>
				        			</div>
				        			<div class="form-group">
				        				<label for="">Giá tiền</label>
				        				<input type="text" class="form-control" id="" name="gt" placeholder="Enter price" value="<?= $value['Price'] ?>" required>
				        			</div>
				        			<div class="form-group">
				        				<label for="">
				        				Ảnh
									<img src="<?= $value['URL_IMG'] ?>" width="100px" height="100px">
				        			</label>
				        				<input type="file" class="form-control" id="" name="avt" placeholder="Choose image" value="<?= $value['URL_IMG'] ?>">
				        				<input type="hidden" class="form-control" id="" name="avatar" placeholder="Choose image" value="<?= $value['URL_IMG'] ?>">
				        			</div>
				        			<div class="form-group">
