$(document).ready(function() {
	$('.nutdangnhap').click(function(event) {
		$('.dangnhap').addClass('hienthira');
		$('.nenxam').addClass('ra');
	});
	$('.nenxam').click(function(event) {
		$('.dangnhap').removeClass('hienthira');
		$('.nenxam').removeClass('ra');
		$('.dangky').removeClass('dira');
		$('.dangnhap').removeClass('divao');
	});
    ...
    $('._1khoi').hover(function() {
    	...
    	$(this).children('a').children('.card').children('.imgProduct').css({
    		transform: 'translateY(-15px)'
    	});
    	$(this).children('a').children('.card').children('.card-block').children('.nameProduct').css({
    		color: 'blue'
    	});
    ...
    // var tiensp = document.getElementsClassName('')
    // di chuột giỏ hàng
